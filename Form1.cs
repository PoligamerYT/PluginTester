...
namespace PluginTester
{
    public partial class Form1 : Form
    {
                    ...
                    else if (comboBox1.SelectedIndex == 2)
                    {
                        switch (comboBox2.Text)
                        {
                            case "1.19":
                                wc.DownloadProgressChanged += wc_DownloadProgressChanged;
                                wc.DownloadFileCompleted += Wc_DownloadFileCompleted;
                                wc.DownloadFileAsync(new Uri($"https://api.papermc.io/v2/projects/paper/versions/1.19.3/builds/420/downloads/paper-1.19.3-420.jar"), System.IO.Path.Combine(Path, "Servers", $"{comboBox2.Text}-{comboBox1.Text}", $"paper-{comboBox2.Text}.jar"));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Select Java First Please", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
